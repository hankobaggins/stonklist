...
const rules: [string, string][] = [
  ...
  ["we hodl", "Deposits are final. We don't sell, and we don't send anything back. If your token goes to zero, your bag goes to zero. Dividends already earned stay in the score."],
  ...
  ["dividends tracked, not promised", "We show what has landed in the wallet, nothing more. We don't post projections or APY numbers, and nothing is guaranteed."],
